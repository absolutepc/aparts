const STORE_KEY = 'aparts_data_v30';
const DATA_JS_VERSION = '30';
...
const DEFAULT_PROPERTIES = [
  {
    ...
    flatVariants: [
      { flatType: '1room', totalApartments: 58, areaMin: 52, areaMax: 67,layouts: [
        ...
        { key: 'В-Б', label: '1Б - 53м²', areaMin: 53, areaMax: 53, planImg: 'img/Ан-Нур/an-avdj 1b.jpg' },
        { key: 'В-В', label: '1В - 52м²', areaMin: 52, areaMax: 52, planImg: 'img/Ан-Нур/an-avdj 1v.jpg' },
        { key: 'В-Г', label: '1Г - 66м²', areaMin: 66, areaMax: 66, planImg: 'img/Ан-Нур/an-avdj 1g.jpg' },

        { key: 'Г-Г', label: '1Г - 59м²', areaMin: 59, areaMax: 59, planImg: 'img/Ан-Нур/an-g 1g.jpg' },
        ...
        { key: 'Ж-Б', label: '1Б - 52м²', areaMin: 52, areaMax: 52, planImg: 'img/Ан-Нур/an-avdj 1b.jpg' },
        { key: 'Ж-В', label: '1В - 53м²', areaMin: 53, areaMax: 53, planImg: 'img/Ан-Нур/an-avdj 1v.jpg' },
        { key: 'Ж-Г', label: '1Г - 67м²', areaMin: 67, areaMax: 67, planImg: 'img/Ан-Нур/an-avdj 1g.jpg' },

        { key: 'Е-Д', label: '1Д - 61м²', areaMin: 61, areaMax: 61, planImg: 'img/Ан-Нур/an-be 1d.jpg' },
        { key: 'Е-Е', label: '1Е - 59м²', areaMin: 59, areaMax: 59, planImg: 'img/Ан-Нур/an-be 1e.jpg' },
        { key: 'Е-Ж', label: '1Ж - 59м²', areaMin: 59, areaMax: 59, planImg: 'img/Ан-Нур/an-be 1j.jpg' },
        { key: 'Е-И', label: '1И - 61м²', areaMin: 61, areaMax: 61, planImg: 'img/Ан-Нур/an-be 1i.jpg' },
      ...
      { flatType: '2room', totalApartments: 54, areaMin: 57, areaMax: 84, layouts: [
        ...
        { key: 'Г-Г', label: '2Г - 65м²', areaMin: 65, areaMax: 65, planImg: 'img/Ан-Нур/an-g 2g.jpg' },
        ...
        { key: 'Е-Б', label: '2Б - 84м²', areaMin: 84, areaMax: 84, planImg: 'img/Ан-Нур/an-be 2b.jpg' },
        { key: 'Е-В', label: '2В - 82м²', areaMin: 82, areaMax: 82, planImg: 'img/Ан-Нур/an-be 2v.jpg' },
        { key: 'Е-Г', label: '2Г - 82м²', areaMin: 82, areaMax: 82, planImg: 'img/Ан-Нур/an-be 2g.jpg' },
        { key: 'Е-Д', label: '2Д - 84м²', areaMin: 84, areaMax: 84, planImg: 'img/Ан-Нур/an-be 2d.jpg' },
        { key: 'Е-Ж', label: '2Ж - 78м²', areaMin: 78, areaMax: 78, planImg: 'img/Ан-Нур/an-be 2j.jpg' },
        { key: 'Е-И', label: '2И - 74м²', areaMin: 74, areaMax: 74, planImg: 'img/Ан-Нур/an-be 2i.jpg' },
        { key: 'Е-К', label: '2К - 81м²', areaMin: 81, areaMax: 81, planImg: 'img/Ан-Нур/an-be 2k.jpg' },
        { key: 'Е-Л', label: '2Л - 80м²', areaMin: 80, areaMax: 80, planImg: 'img/Ан-Нур/an-be 2l.jpg' },
        { key: 'Е-Н', label: '2Н - 78м²', areaMin: 78, areaMax: 78, planImg: 'img/Ан-Нур/an-be 2n.jpg' },

        { key: 'Ж-А', label: '2А - 58м²', areaMin: 57, areaMax: 57, planImg: 'img/Ан-Нур/an-avdj 2a.jpg' },
      ...
      { flatType: '3room', totalApartments: 10, areaMin: 93, areaMax: 95, layouts: [
        ...
        { key: 'Д-Б', label: '3Б - 93м²', areaMin: 93, areaMax: 93, planImg: 'img/Ан-Нур/an-avdj 3a.jpg' },
...

  {
    id: 'jk7',
    title: 'ЖК «Лэвел»',
    description: 'ЖК Level — это новый проект, разработанный с учётом всех современных требований к комфорту и функциональности. Расположенный в самом центре города, он сочетает жилые и коммерческие помещения, предлагая жителям и инвесторам уникальные возможности для жизни и бизнеса. ЖК Левел включает в себя 28 этажей, из которых два первых этажа предназначат для коммерческого использования. Остальные 25 этажей занимают жилые квартиры, где на каждом этаже располагается по 14 апартаментов. Высота жилых этажей составляет 3,4 метра, а коммерческих — 4,2 метра, что создаёт ощущение простора и открытости в каждом помещении. Здание завершается техническим этажом, что улучшает эксплуатационные характеристики комплекса.',
    type: 'jk',
    flatType: '1room',
    totalApartments: 20,
    flatVariants: [
      { flatType: '1room', totalApartments: 20, areaMin: 37.77, areaMax: 51.92, layouts: [
        { key: '3-А', label: '1К-13 37.77м²', areaMin: 37.77, areaMax: 37.77, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '3-Б', label: '1К-15 37.78м²', areaMin: 37.78, areaMax: 37.78, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '4-А', label: '1К-3 46.65м²', areaMin: 46.65, areaMax: 46.65, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '4-Б', label: '1К-16 37.79м²', areaMin: 37.79, areaMax: 37.79, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '5-А', label: '1К-3 46.65м²', areaMin: 46.65, areaMax: 46.65, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '17-А', label: '1К-8 51.18м²', areaMin: 51.18, areaMax: 51.18, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '21-А', label: '1К-3 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '22-А', label: '1К-16 38.74м²', areaMin: 38.74, areaMax: 38.74, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '23-А', label: '1К-10 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },
        
        { key: '24-А', label: '1К-10 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },
        
        { key: '26-А', label: '1К-10 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '27-А', label: '1К-3 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '27-Б', label: '1К-10 47.39м²', areaMin: 47.39, areaMax: 47.39, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '27-В', label: '1К-12 51.86м²', areaMin: 51.86, areaMax: 51.86, planImg: 'img/ривьера/1К-1.jpg' },

        { key: '28-А', label: '1К-1 51.92м²', areaMin: 51.92, areaMax: 51.92, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '28-Б', label: '1К-12 51.86м²', areaMin: 51.86, areaMax: 51.86, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '28-В', label: '1К-14 38.67м²', areaMin: 38.67, areaMax: 38.67, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '28-Г', label: '1К-15 38.74м²', areaMin: 38.74, areaMax: 38.74, planImg: 'img/ривьера/1К-1.jpg' },
        { key: '28-Д', label: '1К-16 38.74м²', areaMin: 38.74, areaMax: 38.74, planImg: 'img/ривьера/1К-1.jpg' },

      ] },


      { flatType: 'studio', totalApartments: 100, areaMin: 31.43, areaMax: 31.43, layouts: [
        { key: '18-А', label: 'С-4 31.43м²', areaMin: 31.43, areaMax: 31.43, planImg: 'img/ривьера/2К-2.jpg' },
      ] },
    ...
    areaMax: 51.92,
    price: 82000,
    address: '3-й Гаражный пер. / Гаражная ул.',
    district: 'Новый район',
    location: { lat: 43.332300, lng: 45.668622 },
    developer: 'Квартал 777',
    noMarkupYears: 2,
    mandatoryPayment: 3000,
...

  {
    id: 'jk8',
    title: 'ЖК «Сенатор»',
    description: 'ЖК Сенатор в Грозном выполнен в стиле хай-тек, что подчеркивается элегантными линиями, высококачественными материалами и инновационными решениями в архитектуре. Комплекс состоит из семи секций, шесть из которых – это жилые дома с просторными квартирами, а одна секция отведена под современное офисное здание. Это создает уникальную синергию работы и жизни, позволяя жителям наслаждаться всеми удобствами в одном месте. Высокий уровень комфорта и безопасност. Каждый жилой дом в Black Rock в Грозном оснащен передовыми системами безопасности и автоматизации. Это включает в себя круглосуточное видеонаблюдение, системы контроля доступа и умные домофоны, обеспечивающие максимальный уровень безопасности для всех жителей. Инновационные решения в архитектуре и строительстве делают проживание в комплексе комфортным и удобным.',
    type: 'jk',
    flatType: '1room',
    totalApartments: 2,
    flatVariants: [
    ...
    noMarkupYears: 1,
    mandatoryPayment: 5000,
    img: 'img/Сенатор/сенат.jpg',
    images: [
      'img/Сенатор/сенат 1.jpg',
      'img/Сенатор/сенат 2.jpg',
      'img/Сенатор/сенат 3.jpg',
    ],
    published: true,
  },
...

  {
    ...
    totalApartments: 44,
    flatVariants: [
      { flatType: 'studio', totalApartments: 12, areaMin: 20.2, areaMax: 21.85, layouts: [
        { key: 'СА', label: 'СА 21.85м²', areaMin: 21.85, areaMax: 21.85 },
        { key: 'СБ', label: 'СБ 21.73м²', areaMin: 21.73, areaMax: 21.73 },
        { key: 'СВ', label: 'СВ 21.85м²', areaMin: 21.85, areaMax: 21.85 },
        { key: 'СГ', label: 'СГ 20.2м²', areaMin: 20.2, areaMax: 20.2 },
        { key: 'СД', label: 'СД 20.2м²', areaMin: 20.2, areaMax: 20.2 },
        { key: 'СЕ', label: 'СЕ 20.2м²', areaMin: 20.2, areaMax: 20.2 },
      ] },
      { flatType: '1room', totalApartments: 20, areaMin: 40.77, areaMax: 52.89, layouts: [
        { key: '1Б', label: '1Б 50.31м²', areaMin: 50.31, areaMax: 50.31 },
        { key: '1В', label: '1В 46.24м²', areaMin: 46.24, areaMax: 46.24 },
        { key: '1Г', label: '1Г 50.11м²', areaMin: 50.11, areaMax: 50.11 },
        { key: '1Д', label: '1Д 45.65м²', areaMin: 45.65, areaMax: 45.65 },
        { key: '1Е', label: '1Е 45.65м²', areaMin: 45.65, areaMax: 45.65 },
        { key: '1Ж', label: '1Ж 52.89м²', areaMin: 52.89, areaMax: 52.89 },
        { key: '1И', label: '1И 47.01м²', areaMin: 47.01, areaMax: 47.01 },
        { key: '1К', label: '1К 49.99м²', areaMin: 49.99, areaMax: 49.99 },
        { key: '1Л', label: '1Л 40.77м²', areaMin: 40.77, areaMax: 40.77 },
        { key: '1М', label: '1М 40.77м²', areaMin: 40.77, areaMax: 40.77 },
      ] },
      { flatType: '2room', totalApartments: 10, areaMin: 43.57, areaMax: 73.35, layouts: [
        { key: '2А', label: '2А 54.42м²', areaMin: 54.42, areaMax: 54.42 },
        { key: '2Б', label: '2Б 54.42м²', areaMin: 54.42, areaMax: 54.42 },
        { key: '2В', label: '2В 73.35м²', areaMin: 73.35, areaMax: 73.35 },
        { key: '2Г', label: '2Г 43.57м²', areaMin: 43.57, areaMax: 43.57 },
        { key: '2Д', label: '2Д 43.57м²', areaMin: 43.57, areaMax: 43.57 },
      ] },
      { flatType: '3room', totalApartments: 2, areaMin: 83.39, areaMax: 83.39, layouts: [
        { key: '3А', label: '3А 83.39м²', areaMin: 83.39, areaMax: 83.39 },
      ] },
    ],
    areaMin: 20.2,
    areaMax: 83.39,
        ...
        <div class="floor-plan-layout-panel${hiddenClass}" data-layout-key="${escapeAttr(layout.key)}">
          ...
          <ul class="floor-plan-specs">
            ...
            <li class="floor-plan-spec-calc">
              <a href="calc.html?id=${encodeURIComponent(property.id)}&sector=${encodeURIComponent(selectedSector?.id || '')}&flatType=${encodeURIComponent(variant.flatType)}&layout=${encodeURIComponent(layout.key)}" class="btn btn-primary btn-sm" style="width: 100%; margin-top: 10px;">Рассчитать стоимость</a>
            </li>
          </ul>
        </div>
      `;
...
const COMPLEX_PROPERTY_CONFIGS = {
  ...
  layouts: {
    ...
    'Д': {
      '1room': {
        'Д-A': { totalApartments: 6, availableFloors: '11-16' },
        'Д-Б': { totalApartments: 3, availableFloors: '11, 14, 16' },
        'Д-В': { totalApartments: 1, availableFloors: '16' },
    ...
    'Е': {
      ...
      '2room': {
        ...
        'Е-Л': { totalApartments: 2, availableFloors: '14, 16' },
        'Е-Н': { totalApartments: 1, availableFloors: '16' },
      },
    },
  ...
  floorPriceRanges: [
    ...
    { floorMin: 8, floorMax: 11, price: 84000 },
    { floorMin: 12, floorMax: 28, price: 82000 },
  ],
  floorPriceColumnLabels: { from: 'Наличка', to: 'БЕЗ ВЗНОСА' },
  floorPriceToOffset: 4000,
  sectorHeading: 'Этаж',

  sectorOrder: ['3', '4', '5', '17', '18', '21', '22', '23', '24', '26', '27', '28'],

  layouts: {
    '3': {
      '1room': {
        '3-А': { totalApartments: 1, availableFloors: '3' },
        '3-Б': { totalApartments: 1, availableFloors: '3' },
      },
    },

    '4': {
      '1room': {
        '4-А': { totalApartments: 1, availableFloors: '4' },
        '4-Б': { totalApartments: 1, availableFloors: '4' },
      },
    },

    '5': {
      '1room': {
        '5-А': { totalApartments: 1, availableFloors: '5' },
      },
    },

    '17': {
      '1room': {
        '17-А': { totalApartments: 1, availableFloors: '17' },
      },
    },

    '18': {
      'studio': {
        '18-А': { totalApartments: 1, availableFloors: '18' },
      },
    },

    '21': {
      '1room': {
        '21-А': { totalApartments: 1, availableFloors: '21' },
      },
    },

    '22': {
      '1room': {
        '22-А': { totalApartments: 1, availableFloors: '22' },
      },
    },

    '23': {
      '1room': {
        '23-А': { totalApartments: 1, availableFloors: '23' },
      },
    },

    '24': {
      '1room': {
        '24-А': { totalApartments: 1, availableFloors: '24' },
      },
    },

    '26': {
      '1room': {
        '26-А': { totalApartments: 1, availableFloors: '26' },
      },
    },

    '27': {
      '1room': {
        '27-А': { totalApartments: 1, availableFloors: '27' },
        '27-Б': { totalApartments: 1, availableFloors: '27' },
        '27-В': { totalApartments: 1, availableFloors: '27' },
      },
    },

    '28': {
      '1room': {
        '28-А': { totalApartments: 1, availableFloors: '28' },
        '28-Б': { totalApartments: 1, availableFloors: '28' },
        '28-В': { totalApartments: 1, availableFloors: '28' },
        '28-Г': { totalApartments: 1, availableFloors: '28' },
        '28-Д': { totalApartments: 1, availableFloors: '28' },
      },
    },
  ...
  layouts: {
    '1': {
      studio: {
        'СА': { totalApartments: 1, availableFloors: '6-18' },
        'СБ': { totalApartments: 1, availableFloors: '6-18' },
        'СВ': { totalApartments: 1, availableFloors: '6-18' },
        'СГ': { totalApartments: 1, availableFloors: '6-18' },
        'СД': { totalApartments: 1, availableFloors: '6-18' },
        'СЕ': { totalApartments: 1, availableFloors: '6-18' },
      },
      '1room': {
        '1Б': { totalApartments: 1, availableFloors: '6-18' },
        '1В': { totalApartments: 1, availableFloors: '6-18' },
        '1Г': { totalApartments: 1, availableFloors: '6-18' },
        '1Д': { totalApartments: 1, availableFloors: '6-18' },
        '1Е': { totalApartments: 1, availableFloors: '6-18' },
        '1Ж': { totalApartments: 1, availableFloors: '6-18' },
        '1И': { totalApartments: 1, availableFloors: '6-18' },
        '1К': { totalApartments: 1, availableFloors: '6-18' },
        '1Л': { totalApartments: 1, availableFloors: '6-18' },
        '1М': { totalApartments: 1, availableFloors: '6-18' },
      },
      '2room': {
        '2А': { totalApartments: 1, availableFloors: '6-18' },
        '2Б': { totalApartments: 1, availableFloors: '6-18' },
        '2В': { totalApartments: 1, availableFloors: '6-18' },
        '2Г': { totalApartments: 1, availableFloors: '6-18' },
        '2Д': { totalApartments: 1, availableFloors: '6-18' },
      },
      '3room': {
        '3А': { totalApartments: 1, availableFloors: '6-18' },
      },
    },
