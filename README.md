...
- Раздел **ЖК** — жилые комплексы с общим количеством квартир и разбивкой по типам
- Раздел **МФК** — многофункциональные комплексы с теми же параметрами
- Раздел **Коммерческая недвижимость** — площадь (м²)
- **Фильтры** — по количеству квартир, типу планировки и району (для ЖК/МФК)
...
|------|----------|
| `index.html` | Главная |
| `jk.html` | Жилые комплексы (ЖК) |
| `mfk.html` | Многофункциональные комплексы (МФК) |
| `commercial.html` | Коммерческая недвижимость |
| `property.html?id=...` | Карточка объекта |
| `admin.html` | Админ-панель |
| `apartments.html` | Перенаправление на `jk.html` |
